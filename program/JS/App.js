class App {
    ...
    draw_scene = () => {
        if(this.synchronized) {
            ...
            // view/perspective
            let view_matrix = utils.MakeView(this.camera.position_x, this.camera.position_y, this.current_z * this.stretch_correction + this.camera.offset_z, this.camera.elevation, this.camera.angle);
    ...
    update = () => {
        ...
        this.current_z = -(this.current_time-this.song_start_time+this.time_correction) * .001 * this.audio_ground.scale_z;
