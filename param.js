...
let audio_ground_scale_y = 160.0;
let audio_ground_scale_z = 1000.0;
...
let camera_y_min = audio_ground_scale_y * 1.1;
let camera_y_max = audio_ground_scale_y/2 * 0.95;

let camera_z_offset = 0.6 * audio_ground_scale_z;
...
let max_vel_y_up_button = 250.0;
let up_force = gravity * 1.1;
